...
if __name__ == '__main__':
    ...
    required.add_argument('-i', '--input-file', help='Входной файл с зашифрованным текстом', required=True)
    required.add_argument('-k', '--key-file', help='Файл с ключом', required=True)
    required.add_argument('-o', '--output-file', help='Выходной файл с расшифрованным текстом', required=True)
    ...
    rc5 = RC5(args.block_size, args.round_size, key, strip_extra_nulls=True)
